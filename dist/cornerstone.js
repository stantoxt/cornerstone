...
function rescaleImage(baseLayer, targetLayer) {
  ...
  var baseImagePlane = _metaData.metaData.get('imagePlane', baseImage.imageId);
  var targetImagePlane = _metaData.metaData.get('imagePlane', targetImage.imageId);
...
function getDrawImageOffset(targetImageId, referenceImageId) {
  ...
  var targetImagePlane = _metaData.metaData.get('imagePlane', targetImageId);

  if (!targetImagePlane || !targetImagePlane.imagePositionPatient || !targetImagePlane.rowCosines || !targetImagePlane.columnCosines) {
    return offset;
  }

  var referenceImagePlane = _metaData.metaData.get('imagePlane', referenceImageId);
